...
1. [Developing a Web App with Azure Power BI Embedded](https://vlabs.holsystems.com/vlabs/technet?eng=VLabs&auth=none&src=vlabs&altadd=true&labid=25796&lod=true)
...
| Item | Value |
| --- | --- |
| Report File URL | http://aka.ms/crewhealthpbix |
...
1. Ensure that you have the latest version of Power BI Desktop installed.  You can download the latest version from the [Power BI Desktop Downloads](https://powerbi.microsoft.com/en-us/desktop/).
...
1. Download the [CrewHealth.pbix](http://aka.ms/crewhealthpbix) file.
